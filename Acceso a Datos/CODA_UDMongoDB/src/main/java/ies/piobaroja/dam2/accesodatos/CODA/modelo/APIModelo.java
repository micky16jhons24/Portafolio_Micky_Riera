...
public class APIModelo {
	...
	public boolean modificarCliente(int dni, String nombre, String apellido, String telefono, String correo,
			String codigoPostal) {
	...
	public void altaProductoAlquiler(String nombre, String talla, Double precioVenta, boolean disponibilidad,
		...
		AlquilerProducto producto = new AlquilerProducto(nombre, talla, precioVenta, disponibilidad,
				Date.valueOf(fechaAlquiler), // ✅ Conversión de LocalDate a Date
				telefono1, duracionDias);
	...
	public boolean modificarProductoAlquiler(int id, String nombre, String talla, Double precioVenta,
		...
		if (producto != null) {
			...
			producto.setFechaAlquiler(Date.valueOf(fechaAlquiler)); // ✅ Conversión de LocalDate a Date
	...
	public boolean modificacionProducto(int id, String nombre, String talla, Double precioVenta,
