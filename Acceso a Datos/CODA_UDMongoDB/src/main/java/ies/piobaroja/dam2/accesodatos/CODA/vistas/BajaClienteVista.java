...
public class BajaClienteVista extends JPanel {
    private BajaCliente controlador; 
        ...
        bajaButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(JOptionPane.getFrameForComponent(bajaButton), "El DNI debe ser un número entero.");
                }
            }
        });
    }
